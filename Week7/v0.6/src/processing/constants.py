...
ENTRY_POINT = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "datasets"))
...
EXTENSION_RAW_DATA_DIRECTORY = os.path.join(ENTRY_POINT, "extensions-data")
EXTENSION_PREPARED_DATA_DIRECTORY = os.path.join(
    ENTRY_POINT, "extensions-prepared-data"
)
